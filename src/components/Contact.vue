<template>
  ...
  <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
      ...
      <p class="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Got a technical issue?
         Need more details? Let us know.</p>
      <form id="my-form" @submit.prevent="submitForm()" class="space-y-8">
          <div>
              ...
              focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600
               ...
               placeholder="name@flowbite.com" v-model="email" required>
          </div>
          <div>
              ...
              <input type="text" id="subject" class="block p-3 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border
               ...
               dark:focus:border-primary-500 dark:shadow-sm-light" v-model="subject"  placeholder="Let us know how we can help you" required>
          </div>
          <div class="sm:col-span-2">
              ...
              dark:focus:ring-primary-500 dark:focus:border-primary-500" v-model="message" placeholder="Leave a comment..."></textarea>
          </div>
  ...
  export default {
    ...
    methods:{
      submitForm(){
        ...
        fetch("https://formspree.io/f/xayrdeno", {
        method: 'POST',
        body: formData,
        headers: {
